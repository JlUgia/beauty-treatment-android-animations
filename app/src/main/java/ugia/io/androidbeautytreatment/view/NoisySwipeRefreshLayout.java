...
/**
 * Created by joseluisugia on 29/07/14.
 */
/*
 ...
 * instantiates this view needs to add an OnRefreshListener in order to be notified
 ...
 */
public class NoisySwipeRefreshLayout extends ViewGroup {
    ...
    private int mProgressBarOffsetTop = 100;
     ...
     * @param context
     */
    public NoisySwipeRefreshLayout(Context context) {
        this(context, null);
    }
    ...
    public void setProgressBarTopOffset(int progressBarTopOffset) {
        mProgressBarOffsetTop = progressBarTopOffset;
    }
    ...
    private void setTriggerPercentage(float percent) {
        ...
        if (mCurrPercentage == percent) return;
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        case MotionEvent.ACTION_CANCEL:
            ...
            if (mCurrPercentage >= 1) startRefresh();
